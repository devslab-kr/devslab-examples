...
> ✨ **Spring Boot 4 line.** This demo runs against the active `0.5.x` line of `easy-paging-spring-boot-starter` (Spring Boot 4 / Spring Framework 7 / Jackson 3). For the Spring Boot 3.3–3.5 maintenance equivalent, see [`easy-paging-postgres-demo`](../easy-paging-postgres-demo/).
...
cd devslab-examples
git sparse-checkout set easy-paging-sb4-postgres-demo
cd easy-paging-sb4-postgres-demo
```
...
curl -sL https://github.com/devslab-kr/devslab-examples/archive/refs/heads/main.tar.gz \
  | tar -xz --strip-components=2 devslab-examples-main/easy-paging-sb4-postgres-demo
cd easy-paging-sb4-postgres-demo
```
