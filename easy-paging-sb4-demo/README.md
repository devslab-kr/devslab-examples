...
> ✨ **Spring Boot 4 line.** This demo runs against the active `0.5.x` line of `easy-paging-spring-boot-starter` (Spring Boot 4 / Spring Framework 7 / Jackson 3). For the Spring Boot 3.3–3.5 maintenance equivalent, see [`easy-paging-demo`](../easy-paging-demo/).
