...
public class AgentController {
    ...
    public Map<String, Object> attacks() {
        ...
        root.put("description",
                "Twelve natural-language prompts that would coax a LangChain4j-powered " +
                "agent into making an SSRF request. Each is blocked by " +
                "ssrf-guard-langchain4j's tool-executor wrap before the underlying " +
                "fetch_url executor runs.");
